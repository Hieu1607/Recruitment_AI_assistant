...
// tests/markdown-renderer-ordered-list.tsx
...
function parseInline(text2) {
  ...
  return parts.map((part, index) => {
    if (/^<br\s*\/?>$/i.test(part)) {
      return /* @__PURE__ */ import_react.default.createElement("br", { key: index });
    }
    if (part.startsWith("**") && part.endsWith("**")) {
      return /* @__PURE__ */ import_react.default.createElement("strong", { key: index, className: "font-semibold text-fg" }, part.slice(2, -2));
    }
    if (part.startsWith("*") && part.endsWith("*") && part.length > 2) {
      return /* @__PURE__ */ import_react.default.createElement("em", { key: index, className: "italic text-fg" }, part.slice(1, -1));
    }
    if (part.startsWith("`") && part.endsWith("`")) {
...
function renderTable(rows, startIdx) {
  ...
  const bodyRows = separatorIdx >= 0 ? rows.slice(separatorIdx + 1) : rows;
  return /* @__PURE__ */ import_react.default.createElement("div", { key: `table-${startIdx}`, className: "overflow-x-auto mb-3" }, /* @__PURE__ */ import_react.default.createElement("table", { className: "min-w-full text-sm font-sans border-collapse border border-[color:var(--hairline)] rounded-[var(--radius-md)]" }, headerRows.length > 0 && /* @__PURE__ */ import_react.default.createElement("thead", null, headerRows.map((row, ri) => /* @__PURE__ */ import_react.default.createElement("tr", { key: ri, className: "bg-bg-elevated" }, parseTableCells(row).map((cell, ci) => /* @__PURE__ */ import_react.default.createElement(
    "th",
    {
      key: ci,
    ...
    parseInline(cell)
  ))))), /* @__PURE__ */ import_react.default.createElement("tbody", null, bodyRows.map((row, ri) => /* @__PURE__ */ import_react.default.createElement(
    "tr",
    {
      key: ri,
      className: ri % 2 === 0 ? "bg-bg" : "bg-bg-elevated/50"
    },
    parseTableCells(row).map((cell, ci) => /* @__PURE__ */ import_react.default.createElement(
      "td",
      {
        key: ci,
...
function MarkdownRenderer({ text: text2 }) {
    ...
    if (currentListType === "ul") {
      elements.push(
        /* @__PURE__ */ import_react.default.createElement(
          ...
          currentListItems.map((item, index) => /* @__PURE__ */ import_react.default.createElement("li", { key: index, className: "leading-relaxed" }, parseInline(item.content)))
        )
      );
      ...
      elements.push(
        /* @__PURE__ */ import_react.default.createElement(
          ...
          currentListItems.map((item, index) => /* @__PURE__ */ import_react.default.createElement("li", { key: index, className: "leading-relaxed" }, parseInline(item.content), item.nestedUnorderedItems.length > 0 && /* @__PURE__ */ import_react.default.createElement("ul", { className: "list-disc pl-5 mt-2 space-y-1 text-sm font-sans text-fg" }, item.nestedUnorderedItems.map((nestedItem, nestedIndex) => /* @__PURE__ */ import_react.default.createElement("li", { key: nestedIndex, className: "leading-relaxed" }, parseInline(nestedItem))))))
        )
      );
    }
    ...
    if (blockquoteBuffer.length > 0) {
      elements.push(
        /* @__PURE__ */ import_react.default.createElement(
          ...
          /* @__PURE__ */ import_react.default.createElement(MarkdownRenderer, { text: blockquoteBuffer.join("\n") })
        )
      );
      blockquoteBuffer = [];
  ...
  lines.forEach((line, idx) => {
    ...
    if (headingMatch) {
      ...
      const headingClasses = level === 1 ? "text-xl font-semibold mb-2 mt-4 text-fg font-display" : level === 2 ? "text-lg font-semibold mb-2 mt-3 text-fg font-display" : "text-base font-semibold mb-1 mt-2 text-fg font-display";
      const Tag = `h${level}`;
      elements.push(
        /* @__PURE__ */ import_react.default.createElement(Tag, { key: idx, className: headingClasses }, parseInline(content))
      );
      return;
    }
    ...
    if (currentListType) flushList(idx);
    elements.push(
      /* @__PURE__ */ import_react.default.createElement("p", { key: idx, className: "text-sm font-sans text-fg leading-relaxed mb-2" }, parseInline(line))
    );
  });
  if (currentListType) flushList("final");
  flushTable();
  flushBlockquote();
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "space-y-0.5" }, elements);
}
...
var html = (0, import_server.renderToStaticMarkup)(/* @__PURE__ */ import_react2.default.createElement(MarkdownRenderer, { text }));
var orderedListCount = (html.match(/<ol\b/g) ?? []).length;
var unorderedListCount = (html.match(/<ul\b/g) ?? []).length;
...
import_strict.default.ok(!html.includes("</ol><ul"), `Expected nested bullets inside the ordered list item.
${html}`);
import_strict.default.match(html, /Nguyen Minh Hieu[\s\S]*?<ul\b/, `Expected nested bullets under Nguyen Minh Hieu.
${html}`);
import_strict.default.match(html, /Khang Do[\s\S]*?<ul\b/, `Expected nested bullets under Khang Do.
${html}`);
import_strict.default.match(html, /Nguyen Van An[\s\S]*?<ul\b/, `Expected nested bullets under Nguyen Van An.
${html}`);
